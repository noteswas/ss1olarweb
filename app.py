    ...
    <style>
        ...
        * { cursor: url('https://r2.guns.lol/02474717-e633-4558-8434-7b27cf998e3b.png'), auto !important; }
        ...
        #intro {
            ...
            z-index: 100; transition: all 1.2s ease;
            cursor: pointer;
        }
        ...
        .enter-text {
            font-size: 20px; letter-spacing: 4px; opacity: 0.6;
        ...
        .avatar {
            ...
            border: 2px solid #fff; margin: 20px 0; object-fit: cover;
        }
        ...
        .show .social-link:nth-child(1) { transition-delay: 1.2s; }
        .show .social-link:nth-child(2) { transition-delay: 1.3s; }
        .show .social-link:nth-child(3) { transition-delay: 1.4s; }
        .show .social-link:nth-child(4) { transition-delay: 1.5s; }
        .show .social-link:nth-child(5) { transition-delay: 1.6s; }
        ...
        /* Применяем белый цвет ко всем картинкам и SVG в кнопках */
        ...
        footer { position: absolute; bottom: 20px; width: 100%; font-size: 12px; color: #888; }
    </style>
</head>
<body>

    <video id="bgvideo" loop muted playsinline autoplay>
        <source src="https://files.catbox.moe/metor3.mp4" type="video/mp4">
    </video>
    ...
    <div class="overlay" id="main-content">
        <h1 class="fade-item delay-1" style="font-size: 48px; margin: 0;">ss1olarr</h1>
        <img class="avatar fade-item delay-2" src="https://r2.guns.lol/bf9fd2a6-7e37-454d-986f-681c52836bec.webp">
        <p class="fade-item delay-3" style="max-width: 500px; margin: 0 25px; font-size: 18px; opacity: 0.8;">
        ...
        <div class="button-container">
            ...
            <div class="social-link">
                <a href="https://t.me/RobStudio1" target="_blank">
                    <svg viewBox="0 0 24 24"><path fill="currentColor" d="M11.944 0A12 12 0 0 0 0 12a12 12 0 0 0 12 12 12 12 0 0 0 12-12A12 12 0 0 0 12 0a12.356 12.356 0 0 0-.056 0zm4.962 8.224c.127.01.127.01.127.01l-1.907 9.013c-.145.64-.52 1.144-1.092 1.144-.572 0-.858-.415-1.282-.843l-2.073-1.638-1.002-.914c-.167-.146-.333-.292-.49-.44l.024-.03L15.3 9.4c.057-.053.057-.107-.057-.107-.114 0-.17.054-.227.107L7.433 14.54l-2.413-.76c-.52-.164-.52-.516.113-.76l9.642-3.714c.45-.164.886-.067 1.17.266.284.333.284.714.053 1.05z"/></svg>
                </a>
            </div>
            <div class="social-link">
